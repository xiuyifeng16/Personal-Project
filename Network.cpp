...
In this project you will design and implement the network as a "bag of accounts".
*/
#include "Network.hpp"
...
//THIS FUNCTION SHOULD NOT MODIFY THE ORIGINAL FEED. INSTEAD IT SHOULD RETURN A COPY OF THE ORIGINAL FEED SORTED BY USERNAME.
template<typename ItemType>
template <typename Comparator>
LinkedList<Post*>Network<ItemType>::bSortByUsername(Comparator comp,int*counter)
{
    LinkedList<Post*>feedcopy(feed_);//copay feed
    feedcopy.bubbleSort(comp,counter);//call bubbleSort to sort the feed
    return feedcopy;
