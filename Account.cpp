/*name:Xiuyi Feng
  Due Date:11/22/2022
  Account.cpp  
  Define and implement the Account class with a header and a source file.
  Now that accounts are part of a Network, you must also adapt the Account class so 
  that accounts can follow one another.Adding more function to modify posts
*/
#include "Account.hpp"
